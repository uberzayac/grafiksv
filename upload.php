...
try {
    ...
    $webhookUrl = "https://grafiksv.bitrix24.ru/rest/8/cwtdbplshhnj21iy/";
    
    // Имена полей в camelCase
    $fileFieldName = 'ufCrm_1772111130'; // Поле для файлов
    $idsFieldName = 'ufCrm_1772111212';   // Поле для хранения
